...
misc\generateAllTokens.bat: Generates all versions of all tokens in the database.
...
misc\prices.bat: Gives the latest pricing information for decklists. (page no longer exists)
misc\import\mws2cards.bat: Rebuilds the data\cards.csv file from an MWS masterbase.
misc\import\mws2lang.bat: Rebuilds a data\cards-{language}.csv file from an MWS masterbase.
misc\import\ge2cards.bat: Rebuilds the data\cards.csv file from a Gatherer Extractor csv dump.
misc\import\ge2lang.bat: Rebuilds a data\cards-{language}.csv file from an Gatherer Extractor csv dump.
